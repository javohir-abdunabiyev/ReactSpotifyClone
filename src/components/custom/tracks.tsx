...
function TracksFunc() {
    ...
    return (
        <div>
            <h1 className="text-white text-[24px] hover:underline cursor-pointer font-bold !pl-[10px] !mb-[10px]">Популярные альбомы</h1>
            <div className="flex overflow-x-scroll no-scrollbar !pr-[34px] !mb-[40px]">
                {
                    state.map((album: any) => (
                        <div key={album.id} className="relative group flex-shrink-0 max-w-[177px] w-full h-[240px] !p-[12px] hover:bg-[#2c2b2b] rounded-[4px] cursor-pointer">
                            <img
